...
() => {{
    ...
    const storyBase = '//*[@id="root"]/div[4]/div/div[2]/div/div[1]/div[Set]/div[story]/div[1]/div[1]/div/img';
    const xpBase = '//*[@id="root"]/div[4]/div/div[2]/div/div[1]/div[Set]/div[story]/div[2]/div[2]';
    const storyClickBase = '//*[@id="root"]/div[4]/div/div[2]/div/div[1]/div[Set]/div[story]/div[2]/div/div[1]/a[1]';
...
() => {
    continueButton = document.querySelector('#root > div._3W86r._3YKTw > div > div > div._11VOS > div > div > div > button')
...
//Get total XP
() => {
    let sets = document.querySelector('#root > div._1R67g._3YKTw > div > div:nth-child(2) > div > div._1bYhI').getElementsByClassName('_2nLk_');
    let set_list = [];
